...
`
        ...
        unreleased: {
          sections: [
            { name: 'Added', entries: [ 'the thing' ] }
          ]
        },
        releases: [
          {
            version: { major: 1, minor: 2, patch: 3, preRelease: undefined, buildMetaData: undefined },
            date: DateTime.fromISO('2020-12-17', { zone: 'utc' }),
            sections: [
              { name: 'Removed', entries: [ 'something' ]}
            ]
          }
        ]
      })
